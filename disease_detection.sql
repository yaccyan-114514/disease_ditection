...
CREATE TABLE `AIRecords` (
  ...
  `ai_result` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `final_result` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci,
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (11, 1, NULL, '/uploads/f3bd3301849b48a5a0cd2c09a4cdb95d.jpg', '黄瓜霜霉病', '黄瓜霜霉病', '2025-12-09 19:00:41');
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (12, 1, NULL, '/uploads/37de10dbe7c74184a9755fc25adc1cf5.jpg', '识别失败，请稍后重试', 'AI服务暂时不可用: 403 Forbidden: [no body]', '2025-12-09 19:09:08');
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (13, 1, NULL, '/uploads/8d0dfba186e049c4b5d34e5b79851fe6.png', '识别失败，请稍后重试', 'AI服务暂时不可用: 403 Forbidden: [no body]', '2025-12-09 19:10:00');
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (14, 1, NULL, '/uploads/0136d36f76bd41d387bdc5df909b0820.png', '识别失败，请稍后重试', 'AI服务暂时不可用: I/O error on POST request for \"http://localhost:5050/predict\": Connection refused; nested exception is java.net.ConnectException: Connection refused', '2025-12-09 19:36:40');
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (15, 1, NULL, '/uploads/69e6d97c9b014acc8089dff1f73a524f.png', 'Tomato -  Tomato Yellow Leaf Curl Virus (置信度: 42.80%)', '作物: Tomato\n病害:  Tomato Yellow Leaf Curl Virus\n置信度: 42.80%\n\nTomato -  Tomato Yellow Leaf Curl Virus (置信度: 42.80%)\n\n其他可能结果:\n1. Tomato -  Late blight (32.96%)\n2. Tomato -  Septoria leaf spot (8...', '2025-12-09 20:20:48');
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (16, 1, NULL, '/uploads/fe4ce795746d4fa0a9397e1af9b3ab59.png', 'Tomato -  Tomato Yellow Leaf Curl Virus (置信度: 42.80%)', '作物: Tomato\n病害:  Tomato Yellow Leaf Curl Virus\n置信度: 42.80%\n\nTomato -  Tomato Yellow Leaf Curl Virus (置信度: 42.80%)\n\n其他可能结果:\n1. Tomato -  Late blight (32.96%)\n2. Tomato -  Septoria leaf spot (8...', '2025-12-09 20:26:33');
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (17, 1, NULL, '/uploads/e4815509d8694346bfd19728542450be.png', 'Tomato -  Tomato Yellow Leaf Curl Virus (置信度: 42.80%)', '作物: Tomato\n病害:  Tomato Yellow Leaf Curl Virus\n置信度: 42.80%\n\nTomato -  Tomato Yellow Leaf Curl Virus (置信度: 42.80%)\n\n其他可能结果:\n1. Tomato -  Late blight (32.96%)\n2. Tomato -  Septoria leaf spot (8.72%)\n3. Tomato -  Early blight (3.94%)\n', '2025-12-09 20:55:00');
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (18, 1, NULL, '/uploads/aabe2189193346678dd693a00119d516.png', 'Tomato -  Tomato Yellow Leaf Curl Virus (置信度: 42.80%)', '作物: Tomato\n病害:  Tomato Yellow Leaf Curl Virus\n置信度: 42.80%\n\nTomato -  Tomato Yellow Leaf Curl Virus (置信度: 42.80%)\n\n其他可能结果:\n1. Tomato -  Late blight (32.96%)\n2. Tomato -  Septoria leaf spot (8.72%)\n3. Tomato -  Early blight (3.94%)\n', '2025-12-09 20:56:56');
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (19, 1, NULL, '/uploads/08850fe3151045ce98821549f3c9af39.png', 'Tomato -  Tomato Yellow Leaf Curl Virus (置信度: 42.80%)', '作物: Tomato\n病害:  Tomato Yellow Leaf Curl Virus\n置信度: 42.80%\n\nTomato -  Tomato Yellow Leaf Curl Virus (置信度: 42.80%)\n\n其他可能结果:\n1. Tomato -  Late blight (32.96%)\n2. Tomato -  Septoria leaf spot (8.72%)\n3. Tomato -  Early blight (3.94%)\n', '2025-12-09 21:15:45');
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (20, 1, NULL, '/uploads/6ac17188afc4419fac70c2413582e6ec.jpg', '识别失败，请稍后重试', 'AI服务暂时不可用: I/O error on POST request for \"http://localhost:5050/predict\": Connection refused; nested exception is java.net.ConnectException: Connection refused', '2025-12-13 18:55:54');
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (21, 1, NULL, '/uploads/11575d190a5a4be6b94aa928a19c71b3.png', '识别失败，请稍后重试', 'AI服务暂时不可用: I/O error on POST request for \"http://localhost:5050/predict\": Connection refused; nested exception is java.net.ConnectException: Connection refused', '2025-12-13 18:56:03');
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (22, 1, NULL, '/uploads/8e3648fb20cb46629b8891555d371ece.png', 'Tomato -  Tomato Yellow Leaf Curl Virus (置信度: 42.80%)', '作物: Tomato\n病害:  Tomato Yellow Leaf Curl Virus\n置信度: 42.80%\n\nTomato -  Tomato Yellow Leaf Curl Virus (置信度: 42.80%)\n\n其他可能结果:\n1. Tomato -  Late blight (32.96%)\n2. Tomato -  Septoria leaf spot (8.72%)\n3. Tomato -  Early blight (3.94%)\n', '2025-12-13 18:57:07');
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (23, 1, NULL, '/uploads/8f070c476ade4d8687ab7482cd655ca3.jpg', 'Tomato -  Septoria leaf spot (置信度: 59.21%)', '作物: Tomato\n病害:  Septoria leaf spot\n置信度: 59.21%\n\nTomato -  Septoria leaf spot (置信度: 59.21%)\n\n其他可能结果:\n1. Tomato -  Late blight (16.70%)\n2. Tomato -  Early blight (8.49%)\n3. Corn -  healthy (7.25%)\n', '2025-12-13 18:57:24');
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (24, 1, NULL, '/uploads/c3bf70bd907e4763b9a6a69e403b624b.jpg', 'Tomato -  Early blight (置信度: 95.20%)', '作物: Tomato\n病害:  Early blight\n置信度: 95.20%\n\nTomato -  Early blight (置信度: 95.20%)\n\n其他可能结果:\n1. Tomato -  Late blight (2.03%)\n2. Tomato -  Tomato Yellow Leaf Curl Virus (0.90%)\n3. Strawberry -  Leaf scorch (0.78%)\n', '2025-12-13 19:00:29');
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (25, 1, NULL, '/uploads/56c0ad416fed44c9bc6d465ef44296bb.png', 'Tomato -  Tomato Yellow Leaf Curl Virus (置信度: 31.52%)', '作物: Tomato\n病害:  Tomato Yellow Leaf Curl Virus\n置信度: 31.52%\n\nTomato -  Tomato Yellow Leaf Curl Virus (置信度: 31.52%)\n\n其他可能结果:\n1. Orange -  Haunglongbing (Citrus greening) (27.45%)\n2. Corn -  healthy (16.66%)\n3. Tomato -  Septoria leaf spot (12.90%)\n', '2025-12-13 19:00:57');
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (26, 1, NULL, '/uploads/0e6bd931b8d442daaa4dac4d3110e6c6.png', 'Tomato -  Late blight (置信度: 84.34%)', '作物: Tomato\n病害:  Late blight\n置信度: 84.34%\n\nTomato -  Late blight (置信度: 84.34%)\n\n其他可能结果:\n1. Strawberry -  Leaf scorch (6.80%)\n2. Tomato -  Early blight (2.30%)\n3. Squash -  Powdery mildew (1.71%)\n', '2025-12-13 19:32:18');
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (27, 1, NULL, '/uploads/7af1021fafe8470f8564b890249ed150.jpg', 'Corn -  healthy (置信度: 97.40%)', '作物: Corn\n病害:  healthy\n置信度: 97.40%\n\nCorn -  healthy (置信度: 97.40%)\n\n其他可能结果:\n1. Soybean -  healthy (2.52%)\n2. Tomato -  Early blight (0.05%)\n3. Tomato -  Late blight (0.02%)\n', '2025-12-14 09:40:27');
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (28, 1, NULL, '/uploads/c5da8c62b6b24b18a8febf4c393ec578.png', 'Corn -  healthy (置信度: 64.03%)', '作物: Corn\n病害:  healthy\n置信度: 64.03%\n\nCorn -  healthy (置信度: 64.03%)\n\n其他可能结果:\n1. Soybean -  healthy (26.68%)\n2. Strawberry -  healthy (6.98%)\n3. Tomato -  Tomato Yellow Leaf Curl Virus (1.77%)\n', '2025-12-14 09:40:37');
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (29, 1, NULL, '/uploads/19acd46d6f65436e89edf55cd28ae54e.png', 'Tomato -  Tomato Yellow Leaf Curl Virus (置信度: 95.70%)', '作物: Tomato\n病害:  Tomato Yellow Leaf Curl Virus\n置信度: 95.70%\n\nTomato -  Tomato Yellow Leaf Curl Virus (置信度: 95.70%)\n\n其他可能结果:\n1. Soybean -  healthy (3.21%)\n2. Tomato -  Late blight (0.92%)\n3. Strawberry -  healthy (0.09%)\n', '2025-12-14 09:40:46');
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (30, 1, NULL, '/uploads/a96565d98ead4226a05d41a2ecec09b9.jpg', 'Corn -  healthy (置信度: 97.40%)', '作物: Corn\n病害:  healthy\n置信度: 97.40%\n\nCorn -  healthy (置信度: 97.40%)\n\n其他可能结果:\n1. Soybean -  healthy (2.52%)\n2. Tomato -  Early blight (0.05%)\n3. Tomato -  Late blight (0.02%)\n', '2025-12-15 09:38:02');
INSERT INTO `AIRecords` (`id`, `user_id`, `crop_id`, `image_url`, `ai_result`, `final_result`, `created_at`) VALUES (31, 1, NULL, '/uploads/c43f4d91f1044888aab3b521528970be.png', 'Tomato -  Tomato Yellow Leaf Curl Virus (置信度: 95.70%)', '作物: Tomato\n病害:  Tomato Yellow Leaf Curl Virus\n置信度: 95.70%\n\nTomato -  Tomato Yellow Leaf Curl Virus (置信度: 95.70%)\n\n其他可能结果:\n1. Soybean -  healthy (3.21%)\n2. Tomato -  Late blight (0.92%)\n3. Strawberry -  healthy (0.09%)\n', '2025-12-15 21:46:10');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `answers` (`id`, `question_id`, `expert_id`, `answer_text`, `images`, `created_at`) VALUES (1, 1, 1, '根据您描述的症状，这是水稻稻瘟病。主要症状是叶片出现褐色病斑，病斑中央灰白色，边缘褐色。防治方法：1.选用抗病品种；2.合理密植；3.控制氮肥用量；4.发病初期用多菌灵50%可湿性粉剂1:800倍液或甲基托布津70%可湿性粉剂1:1000倍液喷雾防治，每隔7-10天喷一次，连续2-3次。', NULL, '2024-06-10 15:30:00');
INSERT INTO `answers` (`id`, `question_id`, `expert_id`, `answer_text`, `images`, `created_at`) VALUES (2, 2, 2, '根据您描述的症状，这是番茄早疫病。主要症状是叶片出现圆形或椭圆形病斑，病斑中央灰褐色，边缘深褐色，有同心轮纹。防治方法：1.选用抗病品种；2.合理密植；3.控制氮肥用量；4.发病初期用百菌清75%可湿性粉剂1:600倍液或代森锰锌80%可湿性粉剂1:600倍液喷雾防治，每隔7-10天喷一次，连续2-3次。', NULL, '2024-06-12 16:20:00');
INSERT INTO `answers` (`id`, `question_id`, `expert_id`, `answer_text`, `images`, `created_at`) VALUES (3, 3, 4, '根据您描述的症状，这是玉米大斑病。主要症状是叶片出现长条形病斑，病斑中央灰褐色，边缘深褐色。防治方法：1.选用抗病品种；2.合理密植；3.控制氮肥用量；4.及时排水；5.发病初期用代森锰锌80%可湿性粉剂1:600倍液或多菌灵50%可湿性粉剂1:800倍液喷雾防治，每隔7-10天喷一次，连续2-3次。', NULL, '2024-06-15 14:15:00');
INSERT INTO `answers` (`id`, `question_id`, `expert_id`, `answer_text`, `images`, `created_at`) VALUES (4, 4, 1, '根据您描述的症状，这是水稻纹枯病。主要症状是叶鞘和叶片出现云纹状病斑，病斑边缘褐色，中央淡褐色。防治方法：1.选用抗病品种；2.合理密植；3.控制氮肥用量；4.浅水勤灌，及时晒田；5.发病初期用井冈霉素5%水剂1:1000倍液或多菌灵50%可湿性粉剂1:800倍液喷雾防治，每隔7-10天喷一次，连续2-3次。', NULL, '2024-06-18 16:45:00');
INSERT INTO `answers` (`id`, `question_id`, `expert_id`, `answer_text`, `images`, `created_at`) VALUES (5, 5, 2, '根据您描述的症状，这是黄瓜霜霉病。主要症状是叶片出现多角形病斑，病斑初期水渍状，后期变黄褐色，背面有灰黑色霉层。防治方法：1.选用抗病品种；2.合理密植；3.及时通风；4.发病初期用百菌清75%可湿性粉剂1:600倍液或代森锰锌80%可湿性粉剂1:600倍液喷雾防治，每隔7-10天喷一次，连续2-3次。', NULL, '2024-06-20 12:30:00');
INSERT INTO `answers` (`id`, `question_id`, `expert_id`, `answer_text`, `images`, `created_at`) VALUES (6, 6, 6, '根据您描述的症状，这是棉铃虫。主要症状是幼虫蛀食棉铃，造成棉铃脱落或烂铃。防治方法：1.选用抗虫品种；2.合理密植；3.控制氮肥用量；4.发生初期用氯氰菊酯10%乳油1:2000倍液或敌敌畏80%乳油1:800倍液喷雾防治，每隔7-10天喷一次，连续2-3次；5.可以释放赤眼蜂等天敌进行生物防治。', NULL, '2024-06-22 17:20:00');
INSERT INTO `answers` (`id`, `question_id`, `expert_id`, `answer_text`, `images`, `created_at`) VALUES (7, 7, 5, '根据您描述的症状，这是小麦白粉病。主要症状是叶片和茎秆表面出现白色粉状物，严重时叶片变黄枯死。防治方法：1.选用抗病品种；2.合理密植；3.控制氮肥用量；4.及时通风；5.发病初期用三唑酮20%乳油1:1000倍液或多菌灵50%可湿性粉剂1:800倍液喷雾防治，每隔7-10天喷一次，连续2-3次。', NULL, '2024-06-25 13:10:00');
INSERT INTO `answers` (`id`, `question_id`, `expert_id`, `answer_text`, `images`, `created_at`) VALUES (8, 8, 6, '根据您描述的症状，这是茶小绿叶蝉。主要症状是叶片出现黄白色小点，严重时叶片变黄枯死，叶片背面有很多小虫。防治方法：1.选用抗虫品种；2.合理密植；3.控制氮肥用量；4.发生初期用吡虫啉10%可湿性粉剂1:2000倍液或噻虫嗪25%水分散粒剂1:3000倍液喷雾防治，每隔7-14天喷一次，连续2-3次；5.可以释放瓢虫、草蛉等天敌进行生物防治。', NULL, '2024-06-28 15:40:00');
INSERT INTO `answers` (`id`, `question_id`, `expert_id`, `answer_text`, `images`, `created_at`) VALUES (9, 4, 1, '114514', NULL, '2025-12-04 13:58:21');
INSERT INTO `answers` (`id`, `question_id`, `expert_id`, `answer_text`, `images`, `created_at`) VALUES (10, 4, 1, '按图片写', '/uploads/d6182b7eb47544a88fc2e23bceb7aacb.png', '2025-12-04 14:40:38');
INSERT INTO `answers` (`id`, `question_id`, `expert_id`, `answer_text`, `images`, `created_at`) VALUES (11, 1, 1, '我的发，厚礼蟹', '/uploads/1dddeb82ca944181b22f60585699d9e9.jpg', '2025-12-13 19:37:41');
INSERT INTO `answers` (`id`, `question_id`, `expert_id`, `answer_text`, `images`, `created_at`) VALUES (12, 4, 1, '这是什么问题？', '/uploads/ef1ae9496bda4ec483e0bf1c0c54b36b.png', '2025-12-15 21:49:21');
COMMIT;
...
CREATE TABLE `farmers` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `phone` (`phone`),
  KEY `fk_farmers_expert` (`expert_id`),
  CONSTRAINT `fk_farmers_expert` FOREIGN KEY (`expert_id`) REFERENCES `experts` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
-- ----------------------------
BEGIN;
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (1, 1, '张大山', 'male', '15000001001', '320101198001011234', '123456', '江苏省南京市', '南京市江宁区某镇某村123号', 15.50, '水稻、小麦', '2024-01-20 10:00:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (2, 2, '李桂花', 'female', '15000001002', '320101198502021234', '123456', '江苏省苏州市', '苏州市吴中区某镇某村456号', 8.30, '蔬菜、草莓', '2024-01-25 14:30:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (3, 3, '王老五', 'male', '15000001003', '320101197803031234', '123456', '江苏省徐州市', '徐州市铜山区某镇某村789号', 25.00, '玉米、大豆', '2024-02-05 09:15:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (4, 4, '刘翠花', 'female', '15000001004', '320101199004041234', '123456', '江苏省常州市', '常州市武进区某镇某村321号', 12.60, '水稻、油菜', '2024-02-10 11:20:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (5, 5, '陈大牛', 'male', '15000001005', '320101198205051234', '123456', '江苏省无锡市', '无锡市惠山区某镇某村654号', 18.80, '蔬菜、水果', '2024-02-15 16:45:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (6, 6, '赵小芳', 'female', '15000001006', '320101199306061234', '123456', '江苏省南通市', '南通市通州区某镇某村987号', 6.50, '棉花、花生', '2024-03-01 08:30:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (7, 7, '孙建国', 'male', '15000001007', '320101197507071234', '123456', '江苏省盐城市', '盐城市大丰区某镇某村147号', 30.20, '水稻、小麦、玉米', '2024-03-10 13:00:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (8, 1, '周美丽', 'female', '15000001008', '320101198808081234', '123456', '江苏省扬州市', '扬州市江都区某镇某村258号', 10.40, '蔬菜、花卉', '2024-03-20 15:20:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (9, 2, '吴大勇', 'male', '15000001009', '320101198909091234', '123456', '江苏省镇江市', '镇江市丹徒区某镇某村369号', 14.70, '茶叶、果树', '2024-04-05 10:45:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (10, 3, '郑秀兰', 'female', '15000001010', '320101199010101234', '123456', '江苏省泰州市', '泰州市高港区某镇某村741号', 9.20, '水稻、蔬菜', '2024-04-12 12:30:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (11, 4, '马强', 'male', '15000001011', '320101198111111234', '123456', '江苏省宿迁市', '宿迁市宿城区某镇某村852号', 22.30, '小麦、玉米、大豆', '2024-04-20 09:00:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (12, 5, '林小梅', 'female', '15000001012', '320101199212121234', '123456', '江苏省淮安市', '淮安市淮安区某镇某村963号', 7.80, '蔬菜、草莓、葡萄', '2024-05-01 14:15:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (13, 6, '黄大伟', 'male', '15000001013', '320101197313131234', '123456', '江苏省连云港市', '连云港市海州区某镇某村159号', 19.50, '水稻、小麦、棉花', '2024-05-10 11:30:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (14, 7, '徐小丽', 'female', '15000001014', '320101198414141234', '123456', '江苏省南京市', '南京市六合区某镇某村357号', 11.20, '蔬菜、水果、花卉', '2024-05-15 16:00:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (15, 1, '何老六', 'male', '15000001015', '320101197515151234', '123456', '江苏省苏州市', '苏州市相城区某镇某村468号', 16.90, '水稻、油菜、茶叶', '2024-05-20 08:45:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (16, 2, '罗大富', 'male', '15000001016', '320101198616161234', '123456', '江苏省南京市', '南京市浦口区某镇某村111号', 13.40, '水稻、小麦', '2024-05-25 10:00:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (17, 3, '钱小芳', 'female', '15000001017', '320101199717171234', '123456', '江苏省苏州市', '苏州市工业园区某镇某村222号', 9.60, '蔬菜、水果', '2024-06-01 14:20:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (18, 4, '冯大勇', 'male', '15000001018', '320101197818181234', '123456', '江苏省徐州市', '徐州市贾汪区某镇某村333号', 21.80, '玉米、大豆、花生', '2024-06-05 09:30:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (19, 5, '韩小丽', 'female', '15000001019', '320101198919191234', '123456', '江苏省常州市', '常州市新北区某镇某村444号', 8.90, '蔬菜、草莓', '2024-06-10 11:45:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (20, 6, '杨大伟', 'male', '15000001020', '320101197020201234', '123456', '江苏省无锡市', '无锡市锡山区某镇某村555号', 17.30, '水稻、油菜', '2024-06-15 15:00:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (21, 7, '朱小梅', 'female', '15000001021', '320101199121211234', '123456', '江苏省南通市', '南通市崇川区某镇某村666号', 10.70, '棉花、蔬菜', '2024-06-20 08:15:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (22, 1, '秦大强', 'male', '15000001022', '320101198222221234', '123456', '江苏省盐城市', '盐城市亭湖区某镇某村777号', 24.50, '水稻、小麦、玉米', '2024-06-25 13:30:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (23, 2, '许小芳', 'female', '15000001023', '320101199323231234', '123456', '江苏省扬州市', '扬州市广陵区某镇某村888号', 7.20, '蔬菜、花卉', '2024-07-01 10:45:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (24, 3, '何大勇', 'male', '15000001024', '320101197424241234', '123456', '江苏省镇江市', '镇江市京口区某镇某村999号', 15.80, '茶叶、果树', '2024-07-05 14:00:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (25, 4, '施小丽', 'female', '15000001025', '320101198525251234', '123456', '江苏省泰州市', '泰州市海陵区某镇某村101号', 11.90, '水稻、蔬菜', '2024-07-10 09:20:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (26, 5, '张二山', 'male', '15000001026', '320101197626261234', '123456', '江苏省宿迁市', '宿迁市沭阳县某镇某村202号', 20.40, '小麦、玉米', '2024-07-15 12:35:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (27, 6, '李二花', 'female', '15000001027', '320101199727271234', '123456', '江苏省淮安市', '淮安市清江浦区某镇某村303号', 8.10, '蔬菜、草莓、葡萄', '2024-07-20 16:50:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (28, 7, '王二五', 'male', '15000001028', '320101198828281234', '123456', '江苏省连云港市', '连云港市赣榆区某镇某村404号', 18.60, '水稻、小麦、棉花', '2024-07-25 11:05:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (29, 1, '刘二花', 'female', '15000001029', '320101197929291234', '123456', '江苏省南京市', '南京市溧水区某镇某村505号', 12.30, '蔬菜、水果、花卉', '2024-08-01 14:20:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (30, 2, '陈二牛', 'male', '15000001030', '320101199030301234', '123456', '江苏省苏州市', '苏州市昆山市某镇某村606号', 16.20, '水稻、油菜、茶叶', '2024-08-05 09:35:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (31, 3, '赵二芳', 'female', '15000001031', '320101198131311234', '123456', '江苏省徐州市', '徐州市新沂市某镇某村707号', 9.80, '玉米、大豆', '2024-08-10 13:50:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (32, 4, '孙二国', 'male', '15000001032', '320101197232321234', '123456', '江苏省常州市', '常州市金坛区某镇某村808号', 22.70, '水稻、小麦、玉米', '2024-08-15 10:05:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (33, 5, '周二美', 'female', '15000001033', '320101199333331234', '123456', '江苏省无锡市', '无锡市江阴市某镇某村909号', 7.50, '蔬菜、草莓', '2024-08-20 15:20:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (34, 6, '吴二勇', 'male', '15000001034', '320101198434341234', '123456', '江苏省南通市', '南通市如皋市某镇某村110号', 14.40, '棉花、花生', '2024-08-25 11:35:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (35, 7, '郑二兰', 'female', '15000001035', '320101197535351234', '123456', '江苏省盐城市', '盐城市东台市某镇某村211号', 10.60, '水稻、蔬菜', '2024-09-01 09:50:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (36, 1, '马二强', 'male', '15000001036', '320101199636361234', '123456', '江苏省扬州市', '扬州市仪征市某镇某村312号', 19.10, '小麦、玉米、大豆', '2024-09-05 14:05:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (37, 2, '林二梅', 'female', '15000001037', '320101198737371234', '123456', '江苏省镇江市', '镇江市句容市某镇某村413号', 8.70, '蔬菜、草莓、葡萄', '2024-09-10 10:20:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (38, 3, '黄二伟', 'male', '15000001038', '320101197838381234', '123456', '江苏省泰州市', '泰州市兴化市某镇某村514号', 17.90, '水稻、小麦、棉花', '2024-09-15 15:35:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (39, 4, '徐二丽', 'female', '15000001039', '320101199939391234', '123456', '江苏省宿迁市', '宿迁市泗阳县某镇某村615号', 11.50, '蔬菜、水果、花卉', '2024-09-20 11:50:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (40, 5, '何二六', 'male', '15000001040', '320101198040401234', '123456', '江苏省淮安市', '淮安市涟水县某镇某村716号', 13.80, '水稻、油菜、茶叶', '2024-09-25 09:05:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (41, 6, '罗二富', 'male', '15000001041', '320101197141411234', '123456', '江苏省连云港市', '连云港市灌云县某镇某村817号', 20.60, '水稻、小麦', '2024-10-01 14:20:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (42, 7, '钱二芳', 'female', '15000001042', '320101199242421234', '123456', '江苏省南京市', '南京市高淳区某镇某村918号', 9.40, '蔬菜、水果', '2024-10-05 10:35:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (43, 1, '冯二勇', 'male', '15000001043', '320101198343431234', '123456', '江苏省苏州市', '苏州市太仓市某镇某村119号', 15.70, '玉米、大豆、花生', '2024-10-10 15:50:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (44, 2, '韩二丽', 'female', '15000001044', '320101197444441234', '123456', '江苏省徐州市', '徐州市邳州市某镇某村220号', 8.60, '蔬菜、草莓', '2024-10-15 11:05:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (45, 3, '杨二伟', 'male', '15000001045', '320101199545451234', '123456', '江苏省常州市', '常州市溧阳市某镇某村321号', 18.40, '水稻、油菜', '2024-10-20 09:20:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (46, 4, '朱二梅', 'female', '15000001046', '320101198646461234', '123456', '江苏省无锡市', '无锡市宜兴市某镇某村422号', 12.10, '棉花、蔬菜', '2024-10-25 14:35:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (47, 5, '秦二强', 'male', '15000001047', '320101197747471234', '123456', '江苏省南通市', '南通市海安市某镇某村523号', 23.30, '水稻、小麦、玉米', '2024-11-01 10:50:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (48, 6, '许二芳', 'female', '15000001048', '320101199848481234', '123456', '江苏省盐城市', '盐城市建湖县某镇某村624号', 7.30, '蔬菜、花卉', '2024-11-05 15:05:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (49, 7, '何二勇', 'male', '15000001049', '320101198949491234', '123456', '江苏省扬州市', '扬州市高邮市某镇某村725号', 16.50, '茶叶、果树', '2024-11-10 11:20:00', 'active');
INSERT INTO `farmers` (`id`, `expert_id`, `name`, `gender`, `phone`, `id_card`, `password`, `region`, `address`, `farm_size`, `main_crops`, `created_at`, `status`) VALUES (50, 1, '施二丽', 'female', '15000001050', '320101197050501234', '123456', '江苏省镇江市', '镇江市丹阳市某镇某村826号', 10.90, '水稻、蔬菜', '2024-11-15 09:35:00', 'disabled');
COMMIT;
...
CREATE TABLE `messages` (
  ...
  `user_type` enum('farmer','expert') NOT NULL COMMENT '用户类型',
  `answer_id` bigint DEFAULT NULL COMMENT '关联的回答ID',
  `question_id` bigint DEFAULT NULL COMMENT '关联的问题ID',
  ...
  CONSTRAINT `fk_message_answer` FOREIGN KEY (`answer_id`) REFERENCES `answers` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_message_question` FOREIGN KEY (`question_id`) REFERENCES `questions` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='消息通知表';

-- ----------------------------
-- Records of messages
-- ----------------------------
BEGIN;
INSERT INTO `messages` (`id`, `user_id`, `user_type`, `answer_id`, `question_id`, `content`, `is_read`, `created_at`, `read_at`) VALUES (1, 1, 'farmer', 11, 1, '专家回复了您的问题', 1, '2025-12-13 19:37:42', '2025-12-13 19:37:58');
INSERT INTO `messages` (`id`, `user_id`, `user_type`, `answer_id`, `question_id`, `content`, `is_read`, `created_at`, `read_at`) VALUES (2, 4, 'farmer', 12, 4, '专家回复了您的问题', 0, '2025-12-15 21:49:22', NULL);
COMMIT;
...
INSERT INTO `posts` (`id`, `user_id`, `title`, `content`, `images`, `created_at`) VALUES (9, 1, '河异味', '这河异味，河异味啊！！', NULL, '2025-12-11 13:23:17');
INSERT INTO `posts` (`id`, `user_id`, `title`, `content`, `images`, `created_at`) VALUES (10, 1, '河异味', '这河异味，河异味啊！！！', '[\"/uploads/9356fb7a935f47778a3114a7ce091a1a.jpg\"]', '2025-12-11 13:23:39');
COMMIT;
...
CREATE TABLE `private_messages` (
  ...
  `sender_type` enum('farmer','expert') NOT NULL COMMENT '发送者类型',
  `receiver_id` bigint NOT NULL COMMENT '接收者ID',
  `receiver_type` enum('farmer','expert') NOT NULL COMMENT '接收者类型',
