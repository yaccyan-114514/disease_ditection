...
<div class="header">
    <h1>农户详情</h1>
    <a href="${pageContext.request.contextPath}/admin/farmers">返回列表</a>
</div>
<div class="container">
    <div class="card">
        <div class="field">
            <label>ID</label>
            <div class="value">${farmer.id}</div>
        </div>
        <div class="field">
            <label>姓名</label>
        ...
        <div class="field">
            <label>性别</label>
            <div class="value">${farmer.gender == 'male' ? '男' : '女'}</div>
        </div>
        <div class="field">
            <label>手机号</label>
            <div class="value">${farmer.phone}</div>
        </div>
        <div class="field">
            <label>身份证号</label>
            <div class="value">${farmer.idCard}</div>
        </div>
        <div class="field">
            <label>地区</label>
            <div class="value">${farmer.region}</div>
        </div>
        <div class="field">
            <label>地址</label>
            <div class="value">${farmer.address}</div>
        </div>
        <div class="field">
            <label>农场规模</label>
            <div class="value">${farmer.farmSize} 亩</div>
        </div>
        <div class="field">
            <label>主要作物</label>
            <div class="value">${farmer.mainCrops}</div>
        </div>
        <div class="field">
            <label>状态</label>
            <div class="value">${farmer.status == 'active' ? '正常' : '禁用'}</div>
        </div>
        <div class="actions">
            <a href="${pageContext.request.contextPath}/admin/farmers/${farmer.id}/edit" class="btn btn-edit">编辑</a>
            <a href="${pageContext.request.contextPath}/admin/farmers" class="btn btn-back">返回列表</a>
        </div>
    </div>
</div>
</body>
