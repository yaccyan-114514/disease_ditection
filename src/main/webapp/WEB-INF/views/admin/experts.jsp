...
<head>
    ...
    <style>
        * {margin: 0; padding: 0; box-sizing: border-box;}
        ...
        .actions-top {margin-bottom: 16px;}
        ...
        .btn-new {background: #1f883d; color: #fff;}
...
<div class="container">
    ...
    <div class="actions-top">
        <a href="${pageContext.request.contextPath}/admin/experts/new" class="btn btn-new">新建专家</a>
    </div>
    <table>
        <thead>
        <tr>
        ...
        <c:forEach var="expert" items="${experts}">
            <tr>
                ...
                <td>${expert.title}</td>
                <td>${expert.status == 'active' ? '正常' : '禁用'}</td>
                <td>
                    <a href="${pageContext.request.contextPath}/admin/experts/${expert.id}" class="btn btn-edit">查看</a>
                    <a href="${pageContext.request.contextPath}/admin/experts/${expert.id}/edit" class="btn btn-edit">编辑</a>
                    <form method="post" action="${pageContext.request.contextPath}/admin/experts/${expert.id}/delete" style="display: inline;" onsubmit="return confirm('确定要删除这个专家吗？');">
